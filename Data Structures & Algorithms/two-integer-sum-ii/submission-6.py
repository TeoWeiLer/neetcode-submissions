    ...
    def twoSum(self, numbers: List[int], target: int) -> List[int]:
        ...
        for i in range(len(numbers)):
            ...
            if tmp in mp: # keeps the dictionary clean
                # When you run if mp[tmp]:, if tmp isn't in the dictionary, defaultdict creates it and returns 0. (no crashing KeyError if it isnt in the dictionary yet)
            ...
            # In Python, 0 is "Falsy." If the answer was at index 0, if 0: evaluates to False, so the code ignores the correct answer
            # By using i + 1, your first index is 1 instead of 0. Since 1 is "Truthy," the if statement correctly detects the match
        return []